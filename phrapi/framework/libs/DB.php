...
class DB
{
	...
	public function __construct($server = 0)
	{
	...
	{
		if ($config_index === null OR empty($config_index) OR !$config_index) {
			$config_index = 0;
		}
	 ...
	 * @param array $params
	 */
	public function queryAll($sql, $params = null, $fetch_style = PDO::FETCH_OBJ)
	{
		if (empty($sql))
			return false;
	 ...
	 * @param array $params
	 */
	public function queryRow($sql, $params = null, $fetch_style = PDO::FETCH_OBJ)
	{
		if (empty($sql))
			return false;
